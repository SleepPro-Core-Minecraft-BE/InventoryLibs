...
final class DeterministicInventoryLibsTransaction implements InventoryLibsTransaction{

	public function __construct(
		readonly private InventoryLibsTransaction $inner,
		readonly private InventoryLibsTransactionResult $result
	){}
