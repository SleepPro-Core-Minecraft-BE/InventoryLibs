...
final class BlockActorInventoryLibsGraphic implements PositionedInventoryLibsGraphic{
	...
	readonly private BlockInventoryLibsGraphic $block_graphic;
	readonly private Vector3 $position;
	readonly private CompoundTag $tile;
	readonly private ?InventoryLibsGraphicNetworkTranslator $network_translator;
	readonly private int $animation_duration;

	public function __construct(Block $block, Vector3 $position, CompoundTag $tile, ?InventoryLibsGraphicNetworkTranslator $network_translator = null, int $animation_duration = 0){
		$this->block_graphic = new BlockInventoryLibsGraphic($block, $position);
